                ...
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('body') ? 'has-error' : '' }}">
                            ...
                            <textarea name="body" id="editor" rows="10" class="form-control"
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right"
                                       value="{{ old('published_at', $post->published_at ? $post->published_at->format('m/d/Y') : null) }}" id="datepicker" name="published_at">
                            </div>
                            <!-- /.input group -->
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('excerpt') ? 'has-error' : '' }}">
                            ...
                            <textarea name="excerpt" id="" class="form-control" >{{ old('excerpt', $post->excerpt) }}</textarea>
