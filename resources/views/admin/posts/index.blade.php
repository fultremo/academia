            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('admin.posts.destroy', $post) }}" method="POST" style="display: inline">
                        ...
                        <button class="btn btn-xs btn-danger" onclick="return confirm('Seguro que quieres borrarlo')">
                            <i class="fa fa-times"></i>
                        </button>
                    </form>
                    <!--<a href=" //route('admin.posts.destroy', $post) " class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>-->
                </td>
